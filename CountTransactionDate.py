...
window.title("Count Transaction Date Amdocs . ")
...
melabel=Label(window,text="Count Transaction According To \n Date In The Amdocs Bank . ",font=("Times",30,"bold"),bg="powder blue")
...
def mini_statement():
    ...
    q1= """select account_number,count(*)  
        as t_count
        from transaction 
        where transaction_date "2023-08-30"
